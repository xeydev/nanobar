...
public struct PillStyle: Sendable {
    ...
    public init(
        ...
        glassDefault: GlassStateConfig = GlassStateConfig(effect: .clear),
        glassHover:   GlassStateConfig = GlassStateConfig(effect: .regular, tintColor: Color(white: 1, opacity: 0.19)),
